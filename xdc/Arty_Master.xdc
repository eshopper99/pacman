...
## Clock signal
set_property PACKAGE_PIN E3 [get_ports I_CLK_REF_0]
set_property IOSTANDARD LVCMOS33 [get_ports I_CLK_REF_0]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {I_CLK_REF_0}];
...
set_property PACKAGE_PIN V14 [get_ports O_VSYNC]
set_property IOSTANDARD LVCMOS33 [get_ports O_HSYNC]
set_property IOSTANDARD LVCMOS33 [get_ports O_VSYNC]

set_property PACKAGE_PIN G6 [get_ports {HB_Vsync[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {HB_Vsync[0]}]
set_property PACKAGE_PIN J4 [get_ports {HB_HSync[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {HB_HSync[0]}]
set_property PACKAGE_PIN C2 [get_ports I_RESET_0]
set_property IOSTANDARD LVCMOS33 [get_ports I_RESET_0]
set_property PACKAGE_PIN D9 [get_ports {I_BUTTON_0[0]}]
set_property PACKAGE_PIN C9 [get_ports {I_BUTTON_0[1]}]
set_property PACKAGE_PIN B9 [get_ports {I_BUTTON_0[2]}]
set_property PACKAGE_PIN B8 [get_ports {I_BUTTON_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {I_BUTTON_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {I_BUTTON_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {I_BUTTON_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {I_BUTTON_0[0]}]
set_property PACKAGE_PIN A8 [get_ports {I_SW_0[0]}]
set_property PACKAGE_PIN C11 [get_ports {I_SW_0[1]}]
set_property PACKAGE_PIN C10 [get_ports {I_SW_0[2]}]
set_property PACKAGE_PIN A10 [get_ports {I_SW_0[3]}]
...
set_property PACKAGE_PIN T10 [get_ports {O_LED_0[0]}]
set_property PACKAGE_PIN T9 [get_ports {O_LED_0[1]}]
set_property PACKAGE_PIN J5 [get_ports {O_LED_0[2]}]
set_property PACKAGE_PIN H5 [get_ports {O_LED_0[3]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports O_AUDIO_0]

set_property PACKAGE_PIN B11 [get_ports O_AUDIO_0]
set_property PACKAGE_PIN E15 [get_ports {O_VIDEO_R_0[0]}]
set_property PACKAGE_PIN E16 [get_ports {O_VIDEO_R_0[1]}]
set_property PACKAGE_PIN D15 [get_ports {O_VIDEO_R_0[2]}]
set_property PACKAGE_PIN C15 [get_ports {O_VIDEO_R_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_R_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_R_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_R_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_R_0[0]}]
set_property PACKAGE_PIN U12 [get_ports {O_VIDEO_G_0[0]}]
set_property PACKAGE_PIN V12 [get_ports {O_VIDEO_G_0[1]}]
set_property PACKAGE_PIN V10 [get_ports {O_VIDEO_G_0[2]}]
set_property PACKAGE_PIN V11 [get_ports {O_VIDEO_G_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_G_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_G_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_G_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_G_0[0]}]
set_property PACKAGE_PIN J17 [get_ports {O_VIDEO_B_0[0]}]
set_property PACKAGE_PIN J18 [get_ports {O_VIDEO_B_0[1]}]
set_property PACKAGE_PIN K15 [get_ports {O_VIDEO_B_0[2]}]
set_property PACKAGE_PIN J15 [get_ports {O_VIDEO_B_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_B_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_B_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_B_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {O_VIDEO_B_0[0]}]

set_property IOSTANDARD LVCMOS33 [get_ports {HB_CLK[0]}]
set_property PACKAGE_PIN K2 [get_ports {HB_CLK[0]}]
